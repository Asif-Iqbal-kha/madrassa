...
export const MOCK_ADMISSION_APPLICATIONS = [
  {
    ...
    transactionId: 'TXN-98214',
    status: 'admitted',
    queuePosition: 1,
    date: '2026-08-15',
    adminNotes: 'داخلہ منظور، فیس موصول',
  },
  {
    _id: 'adm2',
    ...
    transactionId: 'EP-54321',
    status: 'under_review',
    queuePosition: 2,
    date: '2026-08-18',
    adminNotes: 'ٹیسٹ باقی ہے، فیس تصدیق شدہ',
  },
  {
    _id: 'adm3',
