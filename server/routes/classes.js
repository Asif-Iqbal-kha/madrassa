...
// @desc    Get all classes with dynamic live student count from database
// @access  Public
...
// @desc    Update class (and sync student class names if renamed)
// @access  Admin
router.put('/:id', protect, authorize('master_admin'), async (req, res) => {
  try {
    ...
    // If renamed, keep students in sync
